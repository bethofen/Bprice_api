...
class LorentzianClassification:
    ...
    def __classify(self):
        ...
        # self.df['lastSignalWasBullish'] = lastSignalWasBullish
        # self.df['lastSignalWasBearish'] = lastSignalWasBearish
        ...
        self.df["isBearishRate"] = isBearishRate
        self.df["isBullishRate"] = isBullishRate
